...
public class PatientAppointmentDetailPageTest {
    ...
    public void setUp() throws Exception {
        ...
        try {
            ...
            //appointmentDetailPage = activityTestRule.getActivity();           onView(ViewMatchers.withId(R.id.PatientAppointmentDetailPage)).check(matches(isDisplayed()));
            //check button visible            onView(withId(R.id.DeleteApp)).check(matches(isDisplayed()));
        }
        //clean upp
        finally {
    ...
    public void DeleteCancle () {
        ...
        //check for app date    //onView(withId(R.id.MTillDays)).check(matches(withText("23/11/2021")));     onView(withId(R.id.MTillDays)).check(matches(isDisplayed()));
        //check for app time
        ...
        //click the cancel button      onView(withText(R.string.DeleteCancleApp)).perform(click());
        //nothing happened
    }
