...
import com.ksu.serene.controller.liveChart.draw.data.DrawData;
import com.ksu.serene.controller.liveChart.draw.data.InputData;
import com.ksu.serene.controller.liveChart.utils.DateUtils;
import com.ksu.serene.controller.liveChart.utils.ValueUtils;
...
public class DrawController {
	...
	private int getTitleWidth() {
		...
		String maxValue = String.valueOf(3);
	...
	private void init() {
		...
		linePaint.setColor(res.getColor(R.color.colorAccent));

		strokePaint = new Paint();
		strokePaint.setStyle(Paint.Style.STROKE);
		strokePaint.setAntiAlias(true);
		strokePaint.setStrokeWidth(res.getDimension(R.dimen.line_width));
		strokePaint.setColor(res.getColor(R.color.colorAccent));
