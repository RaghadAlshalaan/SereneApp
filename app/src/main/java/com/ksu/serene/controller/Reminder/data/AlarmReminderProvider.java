...
public class AlarmReminderProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(Reminder.CONTENT_AUTHORITY, Reminder.PATH_VEHICLE, REMINDER);

        sUriMatcher.addURI(Reminder.CONTENT_AUTHORITY, Reminder.PATH_VEHICLE + "/#", REMINDER_ID);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case REMINDER:
                cursor = database.query(Reminder.ReminderEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case REMINDER_ID:
                selection = Reminder.ReminderEntry._ID + "=?";
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (match) {
            case REMINDER:
                return Reminder.ReminderEntry.CONTENT_LIST_TYPE;
            case REMINDER_ID:
                return Reminder.ReminderEntry.CONTENT_ITEM_TYPE;
            default:
    ...
    private Uri insertReminder(Uri uri, ContentValues values) {
        ...
        long id = database.insert(Reminder.ReminderEntry.TABLE_NAME, null, values);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case REMINDER:
                rowsDeleted = database.delete(Reminder.ReminderEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case REMINDER_ID:
                selection = Reminder.ReminderEntry._ID + "=?";
                selectionArgs = new String[] { String.valueOf(ContentUris.parseId(uri)) };
    ...
    private int updateReminder(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(Reminder.ReminderEntry.TABLE_NAME, values, selection, selectionArgs);
