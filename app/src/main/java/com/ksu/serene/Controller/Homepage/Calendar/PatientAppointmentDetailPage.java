    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("PatientSessions")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PatientAppointmentDetailPage.this, "Fails to get data", Toast.LENGTH_LONG);
            }
        });
                                ...
                                db.collection("PatientSessions")
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                Toast.makeText(PatientAppointmentDetailPage.this, "The Appointment reminder deleted successfully", Toast.LENGTH_LONG);
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
                                            @Override
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(PatientAppointmentDetailPage.this, "The Appointment reminder did not delete", Toast.LENGTH_LONG);
                                            }
                                        });
                            }
                        })
