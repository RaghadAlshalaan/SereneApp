    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("PatientMedicin")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PatientMedicineDetailPage.this, "Fails to get data", Toast.LENGTH_LONG);
            }
        });
                                ...
                                db.collection("PatientMedicin")
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                Toast.makeText(PatientMedicineDetailPage.this, "The Med reminder deleted successfully", Toast.LENGTH_LONG);
                                            }
                                        })
                                        .addOnFailureListener(new OnFailureListener() {
                                            @Override
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(PatientMedicineDetailPage.this, "The Med reminder did not delete", Toast.LENGTH_LONG);
                                            }
                                        });
                            }
                        })
